...
I specialise in building scalable, real-time backend systems and autonomous AI agents. Currently building **Plavio.ai**, architecting a scalable agentic system using AWS, LangGraph and FastAPI.
